...
def seed_default_flags(db: Session) -> None:
    ...
    defaults = [
        # ── Phase 1 Core ────────────────────────────────────────────────────
        {
            ...
            "description": "Google Classroom OAuth integration, course/assignment sync, and related features.",
        ...
        },
        {
            "key": "ai_study_tools",
            "name": "AI Study Tools",
            "description": "AI-powered study guide, quiz, and flashcard generation.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        },
        {
            ...
            "description": "In-app messaging between parents and teachers.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        {
            "key": "teacher_email_monitoring",
            "name": "Teacher Email Monitoring",
            "description": "Gmail and Classroom announcement monitoring for teacher communications.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        },
        {
            ...
            "description": "In-app notifications, email reminders, smart reminders, and digest system.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        {
            "key": "inspiration_messages",
            "name": "Inspiration Messages",
            "description": "Motivational quotes displayed on dashboards and in emails.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        # ── Phase 1.5-2 ─────────────────────────────────────────────────────
        {
            ...
            "description": "Sync tasks and assignments to Google Calendar.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        },
        {
            ...
            "description": "Central document repository with search, filter, and RBAC.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        {
            "key": "grade_tracking",
            "name": "Grade Tracking & Submissions",
            "description": "Grade display, report card upload, teacher grade entry, and assignment submission.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        },
        {
            ...
            "description": "Progressive Web App with offline caching and install prompt.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        {
            "key": "notes_projects",
            "name": "Notes & Project Tracking",
            "description": "Color-coded notes, project tracker with milestones and progress bars.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        {
            "key": "faq_knowledge_base",
            "name": "FAQ / Knowledge Base",
            "description": "Community-driven Q&A with admin approval workflow.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        # ── Phase 2+ ────────────────────────────────────────────────────────
        {
            ...
            "description": "Firebase Cloud Messaging push notifications for web and mobile.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        {
            "key": "multi_lms",
            "name": "Multi-LMS Connections",
            "description": "Multi-LMS framework including Canvas and Moodle adapters.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        # ── Phase 3 ─────────────────────────────────────────────────────────
        {
            ...
            "description": "Board-specific course catalogs, student-board linking. OFF by default (requires DTAP approval).",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": False,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        {
            "key": "course_planning",
            "name": "Course Planning & Guidance",
            "description": "Academic plans, semester planner, graduation requirements, AI recommendations, university pathway.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        },
        {
            ...
            "description": "AI writing feedback with grammar, clarity, structure scoring.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        {
            "key": "ai_mock_exams",
            "name": "AI Mock Exams & Sample Exams",
            "description": "AI-generated mock exams, sample exam upload with AI assessment.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        {
            "key": "parent_forum",
            "name": "Parent Discussion Forum",
            "description": "Discussion forum with categories, threads, replies, and moderation.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        },
        {
            ...
            "description": "Searchable teacher resource library with ratings and collections.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        },
        {
            ...
            "name": "Student Streaks & Engagement",
            "description": "Study streak tracking, engagement metrics, and due-for-review sections.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        ...
        # ── Phase 4+ (original flags) ───────────────────────────────────────
        {
            "key": "ai_email_agent",
            "name": "AI Email Agent",
            "description": "AI-drafted email composition, reply ingestion, thread summaries, and searchable archive.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        },
        {
            ...
            "description": "Tutor discovery, booking, reviews, and AI matching.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        },
        {
            "key": "lesson_planner",
            "name": "Lesson Planner",
            "description": "AI-powered lesson planner for teachers (TeachAssist compatible).",
        ...
        },
        {
            ...
            "description": "Adaptive learning, mastery tracking, and learning-style detection.",
            "scope": FlagScope.GLOBAL.value,
            "is_enabled": True,
            "enabled_roles": [],
            "enabled_tiers": [],
        },
        {
            ...
            "description": "Brightspace LMS OAuth2 integration (premium tier only).",
        ...
        },
        {
            "key": "mcp_tools",
            "name": "MCP Tools",
            "description": "MCP (Model Context Protocol) tools for teachers and admins.",
            "scope": FlagScope.ROLE.value,
            "is_enabled": False,
            "enabled_roles": ["teacher", "admin"],
            "enabled_tiers": [],
        },
        {
            "key": "beta_features",
            "name": "Beta Features",
            "description": "Early-access beta features via per-user opt-in.",
