...
| [requirements/features-part7.md](requirements/features-part7.md) | 6.116-6.141 | Bug Reports, Privacy, Board Announcements, Report Cards, Journey Hints, Email Digest, UTDF Framework, Admin Feature Management, **Interactive Learning Engine / Flash Tutor (6.134, CB-ILE-001)**, **Instant Trial & Demo Experience (6.135, CB-DEMO-001)** — §6.135.4–§6.135.9 cover the Apr 20 re-plan (4 feature issues + gamification + brand alignment), **Unified Tutor + Arc Mascot (6.141, CB-TUTOR-001)** — /ask + /flash-tutor merged into single Arc-led /tutor page (Apr 22, PR #3974) |
