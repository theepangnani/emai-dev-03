...
| [requirements/features-part3.md](requirements/features-part3.md) | 6.27-6.54 | Extended features: Messaging, Teacher Linking, Roster, My Kids, Assignments, Enrollment, Invites, Security Phase 2, Reminders, Infrastructure, Admin, Onboarding, Verification, Course Planning, Emails, **Waitlist System (6.53)**, **AI Usage Limits (6.54)** |
