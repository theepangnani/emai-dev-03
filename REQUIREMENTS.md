...
| [requirements/features-part2.md](requirements/features-part2.md) | 6.15-6.27 | UI & Auth features: Themes, Layout, Search, Mobile, UI Polish, Calendar, Parent UX, Security, Multi-Role, Materials Lifecycle, Password Reset, **Design Consistency (6.27)** |
| [requirements/features-part3.md](requirements/features-part3.md) | 6.27-6.55 | Extended features: Messaging, Teacher Linking, Roster, My Kids, Assignments, Enrollment, Invites, Security Phase 2, Reminders, Infrastructure, Admin, Onboarding, Verification, Course Planning, Emails, **Waitlist System (6.53)**, **AI Usage Limits (6.54)**, **Contextual Notes System (6.55)** |
