...
| [requirements/features-part7.md](requirements/features-part7.md) | 6.116-6.150 | Bug Reports, Privacy, Board Announcements, Report Cards, Journey Hints, Email Digest, UTDF Framework, Admin Feature Management, **Interactive Learning Engine / Flash Tutor (6.134, CB-ILE-001)**, **Instant Trial & Demo Experience (6.135, CB-DEMO-001)** — §6.135.4–§6.135.9 cover the Apr 20 re-plan (4 feature issues + gamification + brand alignment), **Unified Tutor + Arc Mascot (6.141, CB-TUTOR-001)** — /ask + /flash-tutor merged into single Arc-led /tutor page (Apr 22, PR #3974), **Rock-solid Tutor v2 + Short Learning Cycle (6.142, CB-TUTOR-002, IN PROGRESS)** — chat-first Q&A + teach-test-coach-loop; epic #4062; Phase 1 streams landed Apr 24 · §6.142.4 quick/full/worksheet modes + per-message PDF + chip UX (Design-Gap remediation, #4374), **Curriculum-Aligned Content Generation & MCP Server (6.150, CB-CMCP-001, DRAFT)** — Ontario CEG + curriculum-guardrail generation pipeline + MCP server; PRD v1.1 binds 4 authenticity amendments (class-context blending, parent companion content type, Arc voice, surface integration via Bridge/DCI/Digest); NOT STARTED, decisions + board-coordinator validation pending |
