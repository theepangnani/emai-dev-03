"""Unit tests for :func:`extract_digest_items` (#3917 / CB-TASKSYNC-001 I5).

The existing HTML-digest tests live in
``tests/test_parent_email_digest_services.py`` and MUST keep passing. This
file only covers the new tool-use extraction path.
"""
